...
If the "resolvers" key is missing, nss-tlsd uses the DNS servers specified in /etc/resolv.conf, assuming they support DoH. nss-tlsd monitors /etc/resolv.conf for changes.
