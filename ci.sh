...
CC=clang meson --prefix=/usr -Dresolvers=9.9.9.9/dns-query,dns.google/dns-query+get,1.1.1.1/dns-query -Dcache=false -Ddeterministic=false -Db_sanitize=address build-asan
